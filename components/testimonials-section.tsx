...
export default function TestimonialsSection() {
  ...
  const scroll = (direction: "left" | "right") => {
    if (direction === "left") {
      ...
      setCurrentIndex((prevIndex) => Math.min(testimonials.length - 3, prevIndex + 1))
    }
  }

  // Calculate visible testimonials
  const getVisibleTestimonials = () => {
    return [testimonials[currentIndex], testimonials[currentIndex + 1], testimonials[currentIndex + 2]]
  }
